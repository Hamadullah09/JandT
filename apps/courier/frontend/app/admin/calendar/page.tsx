...
function Stat({ value, label, colour }: { value: string | number; label: string; colour: string }) {
  return (
    <div className="rounded-xl border-2 border-line bg-white px-4 py-3 sm:px-5">
      <span className="block break-words text-[22px] font-bold leading-tight sm:text-[30px]" style={{ color: colour }}>
        {value}
      </span>
  ...
  return (
    <div className="space-y-6 px-4 py-5 sm:px-6 sm:py-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <h2 className="text-center text-[24px] font-bold text-text-primary sm:min-w-[240px] sm:text-[28px]">
        ...
        <section className="overflow-hidden rounded-xl border-2 border-line bg-white" aria-label="Orders of the chosen day">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b-2 border-line bg-surface-head px-5 py-4">
            <div className="min-w-0">
              <h2 className="break-words text-[20px] font-bold text-text-primary sm:text-[22px]">{dayTitle(selectedDay)}</h2>
