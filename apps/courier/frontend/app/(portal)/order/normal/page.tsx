    ...
    <div className="flex min-h-full flex-col">
      <div className="flex-1 space-y-4 p-5 pb-3">
        ...
        <section className="el-card">
          ...
          <div className="grid grid-cols-1 gap-x-5 gap-y-4 p-5 md:grid-cols-5">
        ...
        <section className="el-card">
          ...
          <div className="grid grid-cols-1 gap-x-5 gap-y-4 p-5 md:grid-cols-5">
            ...
            <div className="min-w-0 md:col-span-4">
              {/* the column headings only make sense once the lines are a row */}
              <div className="hidden grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_170px_124px_40px] gap-x-3 md:grid">
              ...
              <div className="space-y-4 md:space-y-2">
                {lines.map((line, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-2 items-center gap-x-3 gap-y-2 md:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_170px_124px_40px] md:gap-y-0"
                  >
                    <TextInput
                    ...
                    {lines.length > 1 ? (
                      <button
                        ...
                        className="col-span-2 flex h-control items-center justify-center justify-self-end px-3 text-text-secondary hover:text-brand md:col-span-1 md:justify-self-auto md:px-0"
                      >
                        <TrashIcon />
                      </button>
                    ) : (
              ...
              {routeNote && (
                <p className="mt-1 text-base text-text-secondary md:text-right" role="status">
                  {routeNote}
                </p>
              )}
            </div>
      ...
      {/* --------------------------------------------- sticky footer ---- */}
      <div className="sticky bottom-0 z-10 mx-5 mb-5 flex min-h-[66px] flex-wrap items-center justify-end gap-4 rounded border border-line bg-white px-5 py-3 md:h-[66px] md:flex-nowrap md:gap-6 md:py-0">
        {[
